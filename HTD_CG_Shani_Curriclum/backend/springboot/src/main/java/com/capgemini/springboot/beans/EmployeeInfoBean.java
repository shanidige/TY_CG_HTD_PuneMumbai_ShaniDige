...
@JsonInclude(JsonInclude.Include.NON_NULL)  // it will restrict null include details from db
...
//	@JsonIgnore   //it will avoid particular to mapped with json   i.e hide the password
	@XmlTransient
	@Column
